            ...
            <div class="w-full overflow-x-auto">
                ...
                <table class="w-full whitespace-no-wrap">
                    ...
                    <tbody class="bg-white divide-y">
                        <tr v-for="(campaign, index) in campaigns" :key="campaign.id" class="text-gray-700">
                            ...
                            <td class="px-4 py-3 text-xs">
                                ...
                                <span
                                    class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full w-max">{{ campaign.status }}</span>
                            </td>
                            <td class="px-4 py-3 text-sm">
                                {{ campaign.createdAt }}
                            </td>
